...
Figure \ref{Fig.mid_finger_curved} Describe the details and data when finger curved,
Figure \ref{Fig.mid_finger_extended} Describe the details and data when finger extended.


\begin{figure}[htbp]
	\centering 
	\subfigure[mid-finger curved]{
		\label{Fig.mid_finger_curved}
		\includegraphics[width=0.4\textwidth]{imgs/mid_fig_curved.PNG}}
	\subfigure[mid-finger extended]{
		\label{Fig.mid_finger_extended}
		\includegraphics[width=0.5\textwidth]{imgs/mid_fig_extend.PNG}}
	\caption{mid-finger exoskeleton design}
	\label{Fig.mid_finger}
\end{figure}
