...
\begin{figure}[htbp]
	\centering
	\subfloat[bones and joints of a human hand\label{fig:mid_with_connector}]{
		\includegraphics[width=0.65\textwidth]{imgs/mid_with_connector.PNG}
	}
	\hfill
	\subfloat[model of human hand\label{fig:fig_connector}]{
		\includegraphics[width=0.3\textwidth]{imgs/fig_connector.PNG}
	}
	\caption{Human Hand}\label{fig:connecter}
\end{figure}
