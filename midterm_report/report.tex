...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.88\textwidth]{imgs/belt_and_claw.PNG}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.88\textwidth]{imgs/blade3.PNG}
...
At the other end of the box, identical gears to A1 and B1
are fixed to the floor parallel to gears A1 and B1, let us call them A2 and B2(shown Figure~\ref{fig:wolf_belt_claw}).
By using timing belts, two pulleys and belts systems are formed between 
...
timing belts (labelled in Figure~\ref{fig:wolf_belt_claw}) are required to be flexible for our design.  When 3D printing each section 
of the timing belts, removing the supports was an arduous task with low success rates, 
hence we adapted the gears A1,2 and B1,2 (shown Figure~\ref{fig:wolf_belt_claw}) to use the open timing 
...
by a vertical rod with two horizontal plates, as shown in figure~\ref{fig:wolf_belt_claw}, this support would be made 
...
shown in light blue~\ref{fig:gear_comp_mech}. The difficulty of this involves glueing the supports vertical and parallel to the other pulley 
