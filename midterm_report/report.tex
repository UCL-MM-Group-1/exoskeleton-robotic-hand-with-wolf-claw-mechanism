...
%     \draw (2 + \MCP, 0) -- (2 + \MCP, 1.5) -- (-2 + \MCP, 1.5) -- (-2 + \MCP, 0) 
%     -- (-1 + \MCP, -1.5) -- (1 + \MCP, -1.5) -- cycle;
%     \draw (2 + \PIP, 0) -- (2 + \PIP, 1.5) -- (-2 + \PIP, 1.5) -- (-2 + \PIP, 0)
%      -- (-1 + \PIP, -1.5) -- (1 + \PIP, -1.5) -- cycle;
%     \draw (2 + \DIP, 0) -- (2 + \DIP, 1.5) -- (-2 + \DIP, 1.5) -- (-2 + \DIP, 0)
%      -- (-1 + \DIP, -1.5) -- (1 + \DIP, -1.5) -- cycle;

%     \draw[blue] (-2 + \MCP,0) -- (2 + \PIP, 1) -- (2 + \DIP, 0);
% \end{tikzpicture}
